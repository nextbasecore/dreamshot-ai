    ...
    return (
        <div className="w-full flex flex-col lg:flex-row gap-4 items-stretch bg-transparent relative">
            ...
            <div className="flex-1 flex flex-col">
                <div
                    className={`relative rounded-xl p-3 md:p-4 lg:p-6 flex flex-col h-[400px] md:h-[460px] lg:h-[500px] bg-white ${shouldShowBorder1 ? 'border-2 border-dashed border-gray-300' : 'border border-gray-200'
            ...
            <div className="flex-1 flex flex-col">
                <div
                    className={`relative rounded-xl p-3 md:p-4 lg:p-6 flex flex-col h-[400px] md:h-[460px] lg:h-[500px] bg-white ${shouldShowBorder2 ? 'border-2 border-dashed border-gray-300' : 'border border-gray-200'
